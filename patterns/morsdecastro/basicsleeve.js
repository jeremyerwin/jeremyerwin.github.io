...
pat.teeIntersectionPoint("p22","p10",90,"p4","p19")
...
pat.rightPoint("p29","p20",(pat.distance("p25","p27")-hemWidth)/2.0);
pat.perpendicularPoint("p30","p28","p19",-(-pat.distance("p19","p26")));
pat.perpendicularPoint("p31","p19","p30",-(-pat.distance("p19","p29")));
pat.printPoints();
