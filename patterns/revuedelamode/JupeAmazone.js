...
pat.circleLineIntersectionPoint("F","O","D",sideLength,-90.0);
pat.downPoint("F2","D",waist/4.0);
displacementPoint("T","F",-125.0 *scale,-12.0 *scale);
...
pat.circleLineIntersectionPoint("fF","fO2","fB",sideLength,-90.0);
pat.alongPoint("fU","fB","fF",waist/2.0+12.0 *scale);
pat.leftPoint("fU2","fU",37.0 *scale);
pat.circleLineIntersectionPoint("fZ","fE","fA",15.0 *scale,0.0);
displacementPoint("fZ2","fZ",-9.0 *scale,0.5 *scale);
