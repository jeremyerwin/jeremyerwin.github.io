...
pat.displacementPoint("N","U",-1.0 *scale,pat.distance("L","X"));
...
pat.displacementPoint("fA","A",pat.pat.distance("A","B")+3.0 *scale,-2.0 *scale);
...
pat.circleLineIntersectionPoint("fU","fP","fL",pat.pat.distance("P","U")-0.5 *scale,0.0);
...
pat.alongPoint("fH","fR","fDa",pat.pat.distance("R","H"));
pat.alongPoint("d2","d1","fJ",(pat.distance("S","O")+pat.distance("Oa","H")+pat.distance("fH","fC")-waist/2.0)/2.0+2.0 *scale);
pat.teeIntersectionPoint("d3","d1",-90.0,"fC","fH")
pat.teeIntersectionPoint("d4","d2",-90.0,"fC","fH")
pat.alongPoint("d5","d3","fC",((pat.distance("S","O")+pat.distance("Oa","H")+pat.distance("fH","fC"))-waist/2.0-2.0 *scale)/4.0);
pat.alongPoint("d6","d3","fH",((pat.distance("S","O")+pat.distance("Oa","H")+pat.distance("fH","fC"))-waist/2.0-2.0 *scale)/4.0);
pat.alongPoint("d7","d4","fC",((pat.distance("S","O")+pat.distance("Oa","H")+pat.distance("fH","fC"))-waist/2.0-2.0 *scale)/4.0);
pat.alongPoint("d8","d4","fH",((pat.distance("S","O")+pat.distance("Oa","H")+pat.distance("fH","fC"))-waist/2.0-2.0 *scale)/4.0);
pat.printPoints();

pat.line("A","S");
pat.displacedQuad("A","P",pat.distance("A","P")/2.0,-(0.5 *scale));
pat.displacedQuad("N","O",pat.distance("N","O")/2.0,-(1.5 *scale));
pat.displacedQuad("N","R",pat.distance("N","R")/2.0,-(1.0 *scale));
pat.line("R","H");
pat.displacedQuad("N","Oa",pat.distance("N","Oa")/2.0,-(2.0 *scale));
pat.line("S","O");
pat.line("Oa","H");
...
pat.displacedQuad("fYa","fR",pat.distance("fYa","fR")/2.0,-(-3.0 *scale));
pat.line("fR","fH");
pat.line("fZ","fC");
pat.line("fH","d8");
pat.line("d8","d2");
