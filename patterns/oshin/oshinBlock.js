...
var makePattern = function() {
	...
	pat.angleAngleIntersectionPoint("Ю", "А", -90.0, "И", 0.0); //D
	
	pat.downPoint("Л", "И", hipDepth); //E
	pat.angleAngleIntersectionPoint("К", "А", -90.0, "Л", 0.0); //F
	...
	pat.rightPoint("і", "Д", chestWidth); //N
	pat.angleAngleIntersectionPoint("М", "А", 0.0, "і", 90.0); //P
