...
directionPoint("Г2а","Г2",315.0,distance("Г2","Г3")/5.0+0.5 *scale);
directionPoint("Г3а","Г3",225,distance("Г2","Г3")/5.0+0.5 *scale);
...
circleLineIntersectionPoint("А4","а1","А3",distance("А","А0"),0.0);
