...
pat.intersectionPoint("Д","p3","г","д","Б")
...
pat.extendPoint("p44","p3","Д",15.0 *scale);
...
pat.alongPoint("p54","p44","p48",pat.distance("Д","p25")+4.0 *scale);
pat.alongPoint("p53","p25","p54",15.0 *scale);
...
pat.alongPoint("p60","p44","p48",pat.distance("Д","p21")+3.0 *scale);
...
pat.extendPoint("p64","p20","p61",2.0 *scale);
pat.extendPoint("p65","p19","p62",2.0 *scale);
...
pat.rightPoint("p82","p67",5.0 *scale);
pat.printPoints();
